...
os.makedirs("data_old_reward_prior_fixed_2", exist_ok = 1)
...
for k in range(6):
    ...
    filepath2 = "./data_old_reward_prior_fixed_2/RL_network="+str(network_num)+ "_batch_size="+\
        str(batch_size_num)+"_prior_fixed.csv"
