...
b = a.values
table = "table_old_reward_prior_fixed_new.csv"
...
for i in range(6):
    ...
    explo = 0.0
    filepath = "./data_old_reward_prior_fixed_new_2/RL_network="+str(network)+ \
        "_batch_size="+ str(batch_size)+ "_prior_fixed.csv"
