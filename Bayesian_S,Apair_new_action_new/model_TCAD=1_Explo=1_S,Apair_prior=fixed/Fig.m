...
if not(isfolder("RL_fig_prior_fixed"))
    mkdir RL_fig_prior_fixed
end
...
for i = 1:height(I)
    ...
    filename = file + '_prior_fixed.csv';
    str1 = './data_old_reward_prior_fixed_new_2/';
    ...
    save_filename = './RL_fig_prior_fixed/' + file + '.png';
