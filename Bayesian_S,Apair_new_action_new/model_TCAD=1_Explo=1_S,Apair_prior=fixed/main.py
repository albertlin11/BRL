...
os.makedirs("data_old_reward_prior_fixed_new_2", exist_ok = 1)
...
for k in range(3,6):
    ...
    filepath2 = "./data_old_reward_prior_fixed_new_2/RL_network="+str(network_num)+ "_batch_size="+\
