...
if not(isfolder("RL_fig_radius=1_new_2"))
    mkdir RL_fig_radius=1
end
...
for i = 1:height(I)
    ...
    filename = file + '_radius=1.csv';
    str1 = './data_old_reward_radius=1_new_2/';
    ...
    save_filename = './RL_fig_radius=1/' + file + '.png';
